...
# Simulated Example
Here we will generate a regime-switching MCGF process of size 10,000 with the general stationary covariance structure. More specifically, we suppose there are two regimes each with different prevailing winds but the same fully symmetric model. We will begin with simulating the regime process first.
...
par_lagr1 <- list(v1 = 200, v2 = 200, k = 2)
par_lagr2 <- list(v1 = 50, v2 = 150, k = 2)
...
fit_lagr_rs <- fit_lagr(data_mcgf,
    ...
    par_init_ls = list(
        list(lambda = 0.2, v1 = 100, v2 = 100, k = 2),
        list(lambda = 0.2, v1 = 100, v2 = 100, k = 2)
    ),
    control = list(list(iter.max = 10000, eval.max = 10000))
)
