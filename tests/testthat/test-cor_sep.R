test_that("cor_sep() calculates separable correlation", {
    ...
    corr <- cor_sep(spatial = "exp", temporal = "cauchy",
                    par_s = par_s, par_t = par_t, h = h, u = u)

    fit_s <- cor_exp(x = h, c = par_s$c, gamma = par_s$gamma,
...
test_that("cor_sep() calculates separable correlation", {
    ...
    corr <- cor_sep(spatial = "exp", temporal = "exp",
                    par_s = par_s, par_t = par_t, h = h, u = u)
...
test_that("cor_sep() calculates separable correlation", {
    ...
    corr <- cor_sep(spatial = "cauchy", temporal = "cauchy",
                    par_s = par_s, par_t = par_t, h = h, u = u)
